...
func resourceArmVirtualMachineScaleSetRead(d *schema.ResourceData, meta interface{}) error {
	...
	vmsResp, err := vmsClient.ListComplete(ctx, resGroup, name, "", "", "")
	if err != nil {
	...
	vm_hostnames, vm_statuses, vm_primary_private_ip_addresses := flattenAzureRmVirtualMachineScaleSetVMs(vmsResp, meta, resGroup, name)
